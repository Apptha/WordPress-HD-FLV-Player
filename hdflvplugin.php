...
if(isset($arguments['flashvars'])){
   ...
   $mobile = detect_mobile();
    ...
    $output .= '<div id="flashplayer"><embed id="n' . $videoid .$videoid1.$playlist_id. $videoid .$videoid1.$playlist_id. '" wmode="opaque" src="' . $playerpath . '"
...
function hdflvMenuCreate() {
    ...
    add_menu_page(__('hdflv', 'hdflv'), __('Video Player', 'hdflv'), 'edit_pages', "hdflv", "showMenu", get_bloginfo('url') . "/wp-content/plugins/" . dirname(plugin_basename(__FILE__)) . "/images/apptha.png");
...
function FlashOptions() {
    ...
    if ($_POST) {
        ...
        $settingsData               = array();
        $playlist_open = $showTag = $autoplay = $skin_autohide = $ima_ads = $embed_visible = $download = $imageDefault = 
        $playlist_visible = $progressbar = $email = $volumevisible = $shareURL = $timer = $fullscreen = $zoom = $HD_default = $playlistauto = 0;
        if (count($settings) > 0) {
        ...
        $player_values                  = array(
            ...
            'youtube_api'  => $settingsResult['youtube_api']
...
//        } 
        ...
        $settingsData['player_colors'] = serialize($player_color);
            ...
            $settingsdataformat = array('%s','%s', '%s', '%s');
            $wpdb->update($wpdb->prefix . "hdflv_settings", $settingsData, array( 'settings_id' => 1 ),$settingsdataformat);
...
$player_values          = unserialize($fetchSettings->player_values);
    ...
    <script type="text/javascript" src="../wp-content/plugins/<?php echo $contus ?>/js/youtubescript.js"></script>   
...
<?php if ($player_values['fullscreenscale'] == 2) { ?>
                        ...
                        <tr>
                            ...
                            <td><input type='text' name="width"
								...
								please disable few buttons in "Skin Configuration"</span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type='text' name="stagecolor"
                                       value="<?php echo $player_values['stagecolor']; ?>" size=45 /> <span
                                       ...
                                       <div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">
                                           <div class="portlet-header ui-widget-header ui-corner-all">
                                               <span id='ColorSpan'
                                                     ...
                                                     class="<?php echo $className; ?>"></span>Player Color Configuration Ex : 0xdddddd 
                                           </div>
                                                   ...
                                                   <table class="form-table">
                                                       <tr>
                                                           ...
                                                           <td><input type='checkbox' class='check' name="playlist_visible"
                                                                <?php if ($player_icons['playlist_visible'] == 1) { ?> checked <?php } ?>
                                                                      value="1" size=45 />
                                                           </td>
                                                       </tr>
                                                       <tr id="related_playlist_open" style="display:none;">
                                                            <th scope='row'><?php _e("Playlist Open", "video_gallery"); ?></th>
                                                            <td><input type='checkbox' class='check' name="playlist_open" <?php if (isset($player_icons['playlist_open']) && $player_icons['playlist_open'] == 1) { ?> checked <?php } ?> value="1"  /></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                              <select name="relatedVideoView" onchange="enablerelateditems(this.value)">
                                                                        <option value="side"
                                                                        <?php if ($player_values['relatedVideoView'] == 'side')
                                                                        echo "selected=selected"; ?>>side</option>
                                                                        <option value="center"
                                                                        <?php if ($player_values['relatedVideoView'] == 'center')
...
?>
                                ...
                                <?php if ($player_icons['autoplay'] == 1) { ?> checked <?php } ?>
                                                                                                  value="1" size=45 /></td>
                                                                                   </tr>
                                                                                   <tr>
                                                                                       <th scope='row'>Download</th>
                                                                                       <td><input type='checkbox' class='check' name="download"
                                                                       <?php if ($player_icons['download'] == 1) {
                                 ?> checked <?php } ?>
                                                                       value="1" size=45 />&nbsp Note: Not supported for Custom URL and YouTube videos</td>
                                                        </tr>
                                                        <tr>
...
<!--                                    <tr>
                                        ...
                                        <td>
                                            <input name="adsSkip" id="adsSkip" type='radio' value="0"  <?php if ($player_icons['adsSkip'] == 0)
                            echo 'checked'; ?> /><label><?php _e("Enable", "video_gallery"); ?></label>
                                            <input name="adsSkip" id="adsSkip" type='radio' value="1"  <?php if ($player_icons['adsSkip'] == 1)
                            echo 'checked'; ?> /><label><?php _e("Disable", "video_gallery"); ?></label>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type='text' name="adsSkipDuration" value="<?php echo $player_values['adsSkipDuration'] ?>" size=45  />
                                        </td>
                                    </tr>-->
                           <tr>
                               <th scope='row'>IMA Ads</th>
                               <td><input type='checkbox' class='check'
                                       <?php if ($player_icons['ima_ads'] == 1) {
 ?> checked <?php } ?>
                        ...
                        <tr>
                            ...
                            <td><input type='textbox' value="<?php echo $player_values['google_tracker']; ?>" name="google_tracker"  /></td>
                        </tr>
                        <tr>
                            <th scope='row'>Youtube API</th>
                            <td><input type='textbox' value="<?php echo $player_values['youtube_api']; ?>" name="youtube_api"  /></td>
                        </tr>
                    </table>
                </div>
            </div>
...
<?php if ($player_icons['zoom'] == 1) { ?> checked <?php } ?>
                         ...
                         <!-- Display Email Icon-->
                              <tr>
                                  ...
                                  <td><input type='checkbox' class='check'  name="email" <?php if ($player_icons['email'] == 1) { ?> checked <?php } ?>value="1"   /></td>
                              </tr>
                              <!-- Display Share Icon-->
                        <tr>
                            <th scope='row'>Display Share</th>
                            <td><input type='checkbox' class='check'
<?php if ($player_icons['shareURL'] == 1) { ?> checked <?php } ?>
                                       name="shareURL" value="1" size=45 /></td>
                        </tr>
                        <!-- Display Volume Icon-->
                              <tr>
                                  <th scope='row'><?php _e("Display Volume", "video_gallery"); ?></th>
                                  <td><input type='checkbox' class='check'  name="volumevisible" <?php if ($player_icons['volumevisible'] == 1) { ?> checked <?php } ?>value="1"   /></td>
                              </tr>
                              <!-- Display Progress Bar-->
                              <tr>
                                  <th scope='row'><?php _e("Display Progress Bar", "video_gallery"); ?></th>
                                  <td><input type='checkbox' class='check'  name="progressbar" <?php if ($player_icons['progressbar'] == 1) { ?> checked <?php } ?>value="1"   /></td>
                              </tr>
                        <tr>
...
<?php } ?> name="fullscreen" value="1" size=45 /></td>
                        ...
                        <tr>
                            ...
                            <td><input type='checkbox' class='check'
                                       <?php if ($player_icons['skin_autohide'] == 1) {
 ?> checked
...
<!--                        <tr>
                       ...
                       <!--  Display Default Image-->
                        <tr>
                           ...
                           <td><input type='checkbox' class='check' name="imageDefault" <?php if ($player_icons['imageDefault'] == 1) { ?> checked <?php } ?> value="1" size=45  /></td>
                       </tr>                     
                       </table>
                   </div>
               </div>
        ...
        <script type="text/javascript">
        <?php if (isset($player_values['relatedVideoView']) && $player_values['relatedVideoView'] == 'side') {
?>
